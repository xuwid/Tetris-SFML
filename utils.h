...
int bombpoint_1[1][1],bombpoint_2[1][1];
float bombtimer=0,bombdelay=0.4;
//---Shadow Blocks or temporary points which will display shadow---//
int shadow[4][2];
int bombcolor=1;
...
//---To Check uncertain conditions in the shadow array---///
bool shadowanamoly(){
    for (int i=0;i<4;i++)
